...
namespace CheapLoansProject
{
    ...
    /// The class for displaying and handling actions performed by users for CheapLoans.aspx.
    /// </summary>
    public partial class CheapLoans : Page
    {
        ...
        {
            // Determines if the SQL INSERT statement should be ran
            if (Session["date"].ToString() == ViewState["date"].ToString())
            {
        ...
        /// <summary>
        /// Used to conatin code or perform any actions that need to be done in order to run the INSERT statement successfully
        /// </summary>
        /// <param name="sender">Used to represent the "sender"</param>
        /// <param name="e">Represents the event that occurred</param>
        protected void SqlDataSourceCheapLoans_Inserting(object sender, SqlDataSourceCommandEventArgs e)
        {
            ...
            try
            {
                ...
                command.Parameters["@CustName"].Size = 50;
        ...
        /// <summary>
        /// Used to conatin code or perform any actions that need to be done after successfully running the INSERT statement
        /// </summary>
        /// <param name="sender">Used to represent the "sender"</param>
        /// <param name="e">Represents the event that occurred</param>
